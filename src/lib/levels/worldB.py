...
B8 = level.Level(
    players = [
        p.Player(50.0, 50.0,(255, 255, 68), inverted = False),
    ],
    levelObjects = [
        ...
        s.Antiplatform(475, 200, 525, 600, (85, 51, 51)),
        b.Entity(0, 0, 425, 50, (85, 51, 51)),
        b.Entity(550, 0, 650, 50, (85, 51, 51)),
        s.Antiplatform(50, 200, 175, 250, (85, 51, 51)),
        s.Antiplatform(275, 50, 325, 100, (85, 51, 51)),
        b.Entity(400, 600, 650, 650, (85, 51, 51)),
        b.Entity(150, 600, 250, 650, (85, 51, 51)),
        s.Antiplatform(300, 400, 350, 650, (85, 51, 51)),
        s.Antiplatform(175, 350, 350, 400, (85, 51, 51)),
        s.Redirector(200, 50, "up"),
